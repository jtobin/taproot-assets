...
type NewAddrRequest struct {
	...
	SkipProofCourierConnCheck bool `protobuf:"varint,10,opt,name=skip_proof_courier_conn_check,json=skipProofCourierConnCheck,proto3" json:"skip_proof_courier_conn_check,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *NewAddrRequest) GetSkipProofCourierConnCheck() bool {
	if x != nil {
		return x.SkipProofCourierConnCheck
	}
	return false
}
...
type FetchAssetMetaResponse struct {
	...
	// decoding.
	UnknownOddTypes map[uint64][]byte `protobuf:"bytes,4,rep,name=unknown_odd_types,json=unknownOddTypes,proto3" json:"unknown_odd_types,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	CanonicalUniverseUrls []string `protobuf:"bytes,7,rep,name=canonical_universe_urls,json=canonicalUniverseUrls,proto3" json:"canonical_universe_urls,omitempty"`
...
func (x *FetchAssetMetaResponse) GetType() AssetMetaType {
	if x != nil {
		return x.Type
	}
	return AssetMetaType_META_TYPE_OPAQUE
...
func (x *FetchAssetMetaResponse) GetCanonicalUniverseUrls() []string {
	if x != nil {
		return x.CanonicalUniverseUrls
	}
	return nil
}
...
func (x *AnchorTransaction) Reset() {
	*x = AnchorTransaction{}
	mi := &file_taprootassets_proto_msgTypes[82]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnchorTransaction) Descriptor() ([]byte, []int) {
	return file_taprootassets_proto_rawDescGZIP(), []int{82}
}
...
func (x *RegisterTransferRequest) Reset() {
	*x = RegisterTransferRequest{}
	mi := &file_taprootassets_proto_msgTypes[83]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterTransferRequest) Descriptor() ([]byte, []int) {
	return file_taprootassets_proto_rawDescGZIP(), []int{83}
}
...
func (x *RegisterTransferResponse) Reset() {
	*x = RegisterTransferResponse{}
	mi := &file_taprootassets_proto_msgTypes[84]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterTransferResponse) Descriptor() ([]byte, []int) {
	return file_taprootassets_proto_rawDescGZIP(), []int{84}
}
...
func (x *MacaroonPermission) Reset() {
	*x = MacaroonPermission{}
	mi := &file_taprootassets_proto_msgTypes[85]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MacaroonPermission) Descriptor() ([]byte, []int) {
	return file_taprootassets_proto_rawDescGZIP(), []int{85}
}
...
func (x *BakeMacaroonRequest) Reset() {
	*x = BakeMacaroonRequest{}
	mi := &file_taprootassets_proto_msgTypes[86]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BakeMacaroonRequest) Descriptor() ([]byte, []int) {
	return file_taprootassets_proto_rawDescGZIP(), []int{86}
}
...
func (x *BakeMacaroonResponse) Reset() {
	*x = BakeMacaroonResponse{}
	mi := &file_taprootassets_proto_msgTypes[87]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BakeMacaroonResponse) Descriptor() ([]byte, []int) {
	return file_taprootassets_proto_rawDescGZIP(), []int{87}
}
...
type ListAnchoringsRequest struct {
	...
	// Only return anchorings whose sensed phase has this name, when
	// set: one of unwitnessed, witnessed, conflicted, buried,
	// abandoned, withdrawn.
...
type Anchoring struct {
	...
	// The sensed phase: the registry's derived truth, with its
	// evidence summarized.
	Phase string `protobuf:"bytes,3,opt,name=phase,proto3" json:"phase,omitempty"`
	// The phase the owning site last durably acknowledged. The site
	// is converged when this equals the sensed phase.
...
const file_taprootassets_proto_rawDesc = "" +
	"\n" +
	"\x13taprootassets.proto\x12\x06taprpc\x1a\x0ftapcommon.proto\"g\n" +
	"\tAssetMeta\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12)\n" +
	"\x04type\x18\x02 \x01(\x0e2\x15.taprpc.AssetMetaTypeR\x04type\x12\x1b\n" +
	"\tmeta_hash\x18\x03 \x01(\fR\bmetaHash\"\x9c\x01\n" +
	...
	"\x0fasset_specifier\x18\x01 \x01(\v2\x16.taprpc.AssetSpecifierR\x0eassetSpecifier\x12!\n" +
	"\fwith_witness\x18\x02 \x01(\bR\vwithWitness\x12#\n" +
	"\rinclude_spent\x18\x03 \x01(\bR\fincludeSpent\x12%\n" +
	"\x0einclude_leased\x18\x04 \x01(\bR\rincludeLeased\x12:\n" +
	"\x19include_unconfirmed_mints\x18\x05 \x01(\bR\x17includeUnconfirmedMints\x12B\n" +
	"\x0fscript_key_type\x18\x06 \x01(\v2\x1a.taprpc.ScriptKeyTypeQueryR\rscriptKeyType\";\n" +
	"\x12FetchAssetResponse\x12%\n" +
	"\x06assets\x18\x01 \x03(\v2\r.taprpc.AssetR\x06assets\"\xac\x04\n" +
	...
	" \x01(\v2\x1a.taprpc.ScriptKeyTypeQueryR\rscriptKeyType\x12\x16\n" +
	"\x06offset\x18\v \x01(\x05R\x06offset\x12\x14\n" +
	"\x05limit\x18\f \x01(\x05R\x05limit\x123\n" +
	"\tdirection\x18\r \x01(\x0e2\x15.taprpc.SortDirectionR\tdirection\"\xbb\x02\n" +
	"\n" +
	"AnchorInfo\x12\x1b\n" +
	...
	"\x15unconfirmed_transfers\x18\x03 \x01(\x04R\x14unconfirmedTransfers\x1aV\n" +
	...
	"\x05addrs\x18\x01 \x03(\v2\f.taprpc.AddrR\x05addrs\"\xdc\x03\n" +
	...
	"\x0faddress_version\x18\b \x01(\x0e2\x13.taprpc.AddrVersionR\x0eaddressVersion\x12\x1b\n" +
	"\tgroup_key\x18\t \x01(\fR\bgroupKey\x12@\n" +
	"\x1dskip_proof_courier_conn_check\x18\n" +
	" \x01(\bR\x19skipProofCourierConnCheck\"y\n" +
	...
	"\thas_proof\x18\b \x01(\bR\bhasProof\"\xa5\x02\n" +
	"\x13AddrReceivesRequest\x12\x1f\n" +
	"\vfilter_addr\x18\x01 \x01(\tR\n" +
	"filterAddr\x12<\n" +
	"\rfilter_status\x18\x02 \x01(\x0e2\x17.taprpc.AddrEventStatusR\ffilterStatus\x12'\n" +
	...
	"\rsync_to_chain\x18\b \x01(\bR\vsyncToChain\"\xa6\x01\n" +
	...
	"assetIdStr\x12$\n" +
	"\rmeta_hash_str\x18\x04 \x01(\tH\x00R\vmetaHashStrB\a\n" +
	"\x05asset\"\xd4\x03\n" +
	"\x16FetchAssetMetaResponse\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12)\n" +
	"\x04type\x18\x02 \x01(\x0e2\x15.taprpc.AssetMetaTypeR\x04type\x12\x1b\n" +
	"\tmeta_hash\x18\x03 \x01(\fR\bmetaHash\x12_\n" +
	"\x11unknown_odd_types\x18\x04 \x03(\v23.taprpc.FetchAssetMetaResponse.UnknownOddTypesEntryR\x0funknownOddTypes\x12'\n" +
	"\x0fdecimal_display\x18\x05 \x01(\rR\x0edecimalDisplay\x121\n" +
	"\x14universe_commitments\x18\x06 \x01(\bR\x13universeCommitments\x126\n" +
	"\x17canonical_universe_urls\x18\a \x03(\tR\x15canonicalUniverseUrls\x12%\n" +
	"\x0edelegation_key\x18\b \x01(\fR\rdelegationKey\x1aB\n" +
	"\x14UnknownOddTypesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x04R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01\"\x8c\x02\n" +
	"\x10BurnAssetRequest\x12\x1f\n" +
	"\basset_id\x18\x01 \x01(\fB\x02\x18\x01H\x00R\aassetId\x12&\n" +
	"\fasset_id_str\x18\x02 \x01(\tB\x02\x18\x01H\x00R\n" +
	"assetIdStr\x12$\n" +
	...
	"\x0fasset_specifier\x18\x06 \x01(\v2\x16.taprpc.AssetSpecifierR\x0eassetSpecifierB\a\n" +
	"\x05asset\"\xbf\x01\n" +
	"\x11BurnAssetResponse\x12:\n" +
	"\rburn_transfer\x18\x01 \x01(\v2\x15.taprpc.AssetTransferR\fburnTransfer\x127\n" +
	"\n" +
	"burn_proof\x18\x02 \x01(\v2\x14.taprpc.DecodedProofB\x02\x18\x01R\tburnProof\x125\n" +
	"\vburn_proofs\x18\x03 \x03(\v2\x14.taprpc.DecodedProofR\n" +
	"burnProofs\"z\n" +
	...
	"\ffilter_label\x18\x02 \x01(\tR\vfilterLabel\x12'\n" +
	"\x0fstart_timestamp\x18\x03 \x01(\x03R\x0estartTimestamp\"\xec\x03\n" +
	"\tSendEvent\x12\x1c\n" +
	...
	"\x10registered_asset\x18\x01 \x01(\v2\r.taprpc.AssetR\x0fregisteredAsset\"D\n" +
	"\x12MacaroonPermission\x12\x16\n" +
	"\x06entity\x18\x01 \x01(\tR\x06entity\x12\x16\n" +
	"\x06action\x18\x02 \x01(\tR\x06action\"\xb1\x01\n" +
	"\x13BakeMacaroonRequest\x12<\n" +
	"\vpermissions\x18\x01 \x03(\v2\x1a.taprpc.MacaroonPermissionR\vpermissions\x12\x1e\n" +
	...
	"\n" +
	"stuck_only\x18\x03 \x01(\bR\tstuckOnly\"K\n" +
	...
	"\x0fADDR_VERSION_V1\x10\x02\x12\x13\n" +
	"\x0fADDR_VERSION_V2\x10\x03*\xc9\x01\n" +
	...
	"\aGetInfo\x12\x16.taprpc.GetInfoRequest\x1a\x17.taprpc.GetInfoResponse\x12I\n" +
	"\fBakeMacaroon\x12\x1b.taprpc.BakeMacaroonRequest\x1a\x1c.taprpc.BakeMacaroonResponse\x12O\n" +
...
var file_taprootassets_proto_goTypes = []any{
	...
	(*AssetSpecifier)(nil),                // 11: taprpc.AssetSpecifier
	(*FetchAssetRequest)(nil),             // 12: taprpc.FetchAssetRequest
	(*FetchAssetResponse)(nil),            // 13: taprpc.FetchAssetResponse
	(*ListAssetRequest)(nil),              // 14: taprpc.ListAssetRequest
	(*AnchorInfo)(nil),                    // 15: taprpc.AnchorInfo
	(*GenesisInfo)(nil),                   // 16: taprpc.GenesisInfo
	(*ExternalKey)(nil),                   // 17: taprpc.ExternalKey
	(*GroupKeyRequest)(nil),               // 18: taprpc.GroupKeyRequest
	(*TxOut)(nil),                         // 19: taprpc.TxOut
	(*GroupVirtualTx)(nil),                // 20: taprpc.GroupVirtualTx
	(*GroupWitness)(nil),                  // 21: taprpc.GroupWitness
	(*AssetGroup)(nil),                    // 22: taprpc.AssetGroup
	(*GroupKeyReveal)(nil),                // 23: taprpc.GroupKeyReveal
	(*GenesisReveal)(nil),                 // 24: taprpc.GenesisReveal
	(*DecimalDisplay)(nil),                // 25: taprpc.DecimalDisplay
	(*Asset)(nil),                         // 26: taprpc.Asset
	(*PrevWitness)(nil),                   // 27: taprpc.PrevWitness
	(*SplitCommitment)(nil),               // 28: taprpc.SplitCommitment
	(*ListAssetResponse)(nil),             // 29: taprpc.ListAssetResponse
	(*ListUtxosRequest)(nil),              // 30: taprpc.ListUtxosRequest
	(*ManagedUtxo)(nil),                   // 31: taprpc.ManagedUtxo
	(*ListUtxosResponse)(nil),             // 32: taprpc.ListUtxosResponse
	(*ListGroupsRequest)(nil),             // 33: taprpc.ListGroupsRequest
	(*AssetHumanReadable)(nil),            // 34: taprpc.AssetHumanReadable
	(*GroupedAssets)(nil),                 // 35: taprpc.GroupedAssets
	(*ListGroupsResponse)(nil),            // 36: taprpc.ListGroupsResponse
	(*ListBalancesRequest)(nil),           // 37: taprpc.ListBalancesRequest
	(*AssetBalance)(nil),                  // 38: taprpc.AssetBalance
	(*AssetGroupBalance)(nil),             // 39: taprpc.AssetGroupBalance
	(*ListBalancesResponse)(nil),          // 40: taprpc.ListBalancesResponse
	(*ListTransfersRequest)(nil),          // 41: taprpc.ListTransfersRequest
	(*ListTransfersResponse)(nil),         // 42: taprpc.ListTransfersResponse
	(*ChainHash)(nil),                     // 43: taprpc.ChainHash
	(*AssetTransfer)(nil),                 // 44: taprpc.AssetTransfer
	(*TransferInput)(nil),                 // 45: taprpc.TransferInput
	(*TransferOutputAnchor)(nil),          // 46: taprpc.TransferOutputAnchor
	(*TransferOutput)(nil),                // 47: taprpc.TransferOutput
	(*StopRequest)(nil),                   // 48: taprpc.StopRequest
	(*StopResponse)(nil),                  // 49: taprpc.StopResponse
	(*DebugLevelRequest)(nil),             // 50: taprpc.DebugLevelRequest
	(*DebugLevelResponse)(nil),            // 51: taprpc.DebugLevelResponse
	(*Addr)(nil),                          // 52: taprpc.Addr
	(*QueryAddrRequest)(nil),              // 53: taprpc.QueryAddrRequest
	(*QueryAddrResponse)(nil),             // 54: taprpc.QueryAddrResponse
	(*NewAddrRequest)(nil),                // 55: taprpc.NewAddrRequest
	(*ScriptKeyTypeQuery)(nil),            // 56: taprpc.ScriptKeyTypeQuery
	(*ScriptKey)(nil),                     // 57: taprpc.ScriptKey
	(*KeyLocator)(nil),                    // 58: taprpc.KeyLocator
	(*KeyDescriptor)(nil),                 // 59: taprpc.KeyDescriptor
	(*TapscriptFullTree)(nil),             // 60: taprpc.TapscriptFullTree
	(*TapLeaf)(nil),                       // 61: taprpc.TapLeaf
	(*TapBranch)(nil),                     // 62: taprpc.TapBranch
	(*DecodeAddrRequest)(nil),             // 63: taprpc.DecodeAddrRequest
	(*ProofFile)(nil),                     // 64: taprpc.ProofFile
	(*DecodedProof)(nil),                  // 65: taprpc.DecodedProof
	(*VerifyProofResponse)(nil),           // 66: taprpc.VerifyProofResponse
	(*DecodeProofRequest)(nil),            // 67: taprpc.DecodeProofRequest
	(*DecodeProofResponse)(nil),           // 68: taprpc.DecodeProofResponse
	(*ExportProofRequest)(nil),            // 69: taprpc.ExportProofRequest
	(*UnpackProofFileRequest)(nil),        // 70: taprpc.UnpackProofFileRequest
	(*UnpackProofFileResponse)(nil),       // 71: taprpc.UnpackProofFileResponse
	(*AddrEvent)(nil),                     // 72: taprpc.AddrEvent
	(*AddrReceivesRequest)(nil),           // 73: taprpc.AddrReceivesRequest
	(*AddrReceivesResponse)(nil),          // 74: taprpc.AddrReceivesResponse
	(*SendAssetRequest)(nil),              // 75: taprpc.SendAssetRequest
	(*AddressWithAmount)(nil),             // 76: taprpc.AddressWithAmount
	(*PrevInputAsset)(nil),                // 77: taprpc.PrevInputAsset
	(*SendAssetResponse)(nil),             // 78: taprpc.SendAssetResponse
	(*GetInfoRequest)(nil),                // 79: taprpc.GetInfoRequest
	(*GetInfoResponse)(nil),               // 80: taprpc.GetInfoResponse
	(*FetchAssetMetaRequest)(nil),         // 81: taprpc.FetchAssetMetaRequest
	(*FetchAssetMetaResponse)(nil),        // 82: taprpc.FetchAssetMetaResponse
	(*BurnAssetRequest)(nil),              // 83: taprpc.BurnAssetRequest
	(*BurnAssetResponse)(nil),             // 84: taprpc.BurnAssetResponse
	(*ListBurnsRequest)(nil),              // 85: taprpc.ListBurnsRequest
	(*AssetBurn)(nil),                     // 86: taprpc.AssetBurn
	(*ListBurnsResponse)(nil),             // 87: taprpc.ListBurnsResponse
	(*SubscribeReceiveEventsRequest)(nil), // 88: taprpc.SubscribeReceiveEventsRequest
	(*ReceiveEvent)(nil),                  // 89: taprpc.ReceiveEvent
	(*SubscribeSendEventsRequest)(nil),    // 90: taprpc.SubscribeSendEventsRequest
	(*SendEvent)(nil),                     // 91: taprpc.SendEvent
	(*AnchorTransaction)(nil),             // 92: taprpc.AnchorTransaction
	(*RegisterTransferRequest)(nil),       // 93: taprpc.RegisterTransferRequest
	(*RegisterTransferResponse)(nil),      // 94: taprpc.RegisterTransferResponse
...
var file_taprootassets_proto_depIdxs = []int32{
	...
	11,  // 1: taprpc.FetchAssetRequest.asset_specifier:type_name -> taprpc.AssetSpecifier
	...
	17,  // 11: taprpc.GroupKeyRequest.external_key:type_name -> taprpc.ExternalKey
	19,  // 12: taprpc.GroupVirtualTx.prev_out:type_name -> taprpc.TxOut
	16,  // 13: taprpc.GenesisReveal.genesis_base_reveal:type_name -> taprpc.GenesisInfo
	2,   // 14: taprpc.Asset.version:type_name -> taprpc.AssetVersion
	16,  // 15: taprpc.Asset.asset_genesis:type_name -> taprpc.GenesisInfo
	22,  // 16: taprpc.Asset.asset_group:type_name -> taprpc.AssetGroup
	15,  // 17: taprpc.Asset.chain_anchor:type_name -> taprpc.AnchorInfo
	27,  // 18: taprpc.Asset.prev_witnesses:type_name -> taprpc.PrevWitness
	25,  // 19: taprpc.Asset.decimal_display:type_name -> taprpc.DecimalDisplay
	6,   // 20: taprpc.Asset.script_key_type:type_name -> taprpc.ScriptKeyType
	77,  // 21: taprpc.PrevWitness.prev_id:type_name -> taprpc.PrevInputAsset
	28,  // 22: taprpc.PrevWitness.split_commitment:type_name -> taprpc.SplitCommitment
	26,  // 23: taprpc.SplitCommitment.root_asset:type_name -> taprpc.Asset
...
func file_taprootassets_proto_init() {
	...
	file_taprootassets_proto_msgTypes[73].OneofWrappers = []any{
