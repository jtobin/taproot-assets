...
type Querier interface {
	...
	FetchLiveReorgAnchoringsByWitness(ctx context.Context, witnessTxid []byte) ([]ReorgAnchoring, error)
	...
	InsertReorgDependency(ctx context.Context, arg InsertReorgDependencyParams) error
	...
	SetReorgAnchoringPhase(ctx context.Context, arg SetReorgAnchoringPhaseParams) error
	...
	UnsupersedeSafeTransfers(ctx context.Context, arg UnsupersedeSafeTransfersParams) (int64, error)
